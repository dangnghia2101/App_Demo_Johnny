...
export const Header: FC<HeaderType> = ({ children }) => {
    const {
        bell,
        avatar,
        deposit,
        ...
        <View style={styles.container}>
            ...
            <SafeAreaView style={styles.header}>
                ...
                <View style={[styles.lowerHeader]}>
                    <Animated.View
                        style={[styles.feature, depositViewAnimation]}
                    >
                        <Animated.Image
                            source={deposit}
                    ...
                    <Animated.View
                        style={[styles.feature, withdrawViewAnimation]}
                    >
                        <Animated.Image
                            source={withdraw}
                            style={[styles.featureIcon, featureIconAnimation]}
